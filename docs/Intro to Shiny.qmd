...
The third additional component of Shiny that differs from interactive widgets in R is **reactive expressions**.
...
::: {.fragment}
If deployed online, apps can even be embedded on separate websites whether they were made using R or not
