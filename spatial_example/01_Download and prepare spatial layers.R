...
wind <- st_read("data/BOEM-Renewable-Energy-Shapefiles_1/BOEMWindLeases_OutlinePolys.shp") %>%
  st_transform(4326)
...
# write.csv(sst.coarse.df, "data/Monthly_SST_2021.csv", row.names = FALSE)

# st_write(wind, "data/NE_Offshore_Wind.shp", driver = "ESRI Shapefile", append = F)

# write.csv(tracks.df2, "data/Simulated tracks.csv", row.names = FALSE)
